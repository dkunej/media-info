        	...
        	<div class="container">
	            <div class="row">
	                <div class="col-sm-7 contact-form wow fadeInLeft">
	                    <p>
	                    	Feel free to contact us if you have any questions or suggestions. We will try to answer as soon as possible!
	                    </p>
	                ...
	                <div class="col-sm-5 contact-address wow fadeInUp">
	                    ...
	                    <div class="map"></div>
	                    <h3>Address</h3>
	                    <p>Ulica Damira Tomljenovica 15 <br> 10000, Zagreb, ZG, Croatia</p>
	                    <p>Phone: 00 385 01 234 567</p>
	                </div>
	            </div>
	        </div>
        </div>
